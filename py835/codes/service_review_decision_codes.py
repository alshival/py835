def update():
    ...
    url = "https://x12.org/codes/service-review-decision-reason-codes"
    ...
    df.to_csv('service_review_decision_codes.csv', index=False)
    print("Data has been scraped and saved to 'service_review_decision_codes.csv'")
