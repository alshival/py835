def update():
    ...
    url = "https://x12.org/codes/service-type-descriptor-codes"
    ...
    df.to_csv('service_type_descriptor_codes.csv', index=False)
    print("Data has been scraped and saved to 'service_type_descriptor_codes.csv'")
