def update():
    ...
    url = "https://x12.org/codes/provider-adjustment-reason-codes"
    ...
    df.to_csv('provider_adjustment_reason_codes.csv', index=False)
    print("Data has been scraped and saved to 'provider_adjustment_reason_codes.csv'")
