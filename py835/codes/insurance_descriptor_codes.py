def update():
    ...
    url = "https://x12.org/codes/insurance-descriptor-codes"
    ...
    df.to_csv('insurance_descriptor_codes.csv', index=False)
    print("Data has been scraped and saved to 'insurance_descriptor_codes.csv'")
